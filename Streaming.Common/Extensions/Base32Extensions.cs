...
{
    /// <summary>
    /// Base32Extensions class
    /// All credits goes to https://blogs.technet.microsoft.com/cloudpfe/2018/04/18/base32-encoding-and-decoding-in-c/
    /// </summary>
    public static class Base32Extensions
    {
        ...
        public static string ToBase32String(this byte[] input, bool addPadding = true)
        {
            ...
            // For our purposes we disable padding
            //if (addPadding)
            //{
        ...
        public static byte[] ToByteArrayFromBase32String(this string input)
        {
